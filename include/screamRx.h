    ...
    */
    ...
    public:
        ...
        */
        ...
        volatile uint16_t highestSeqNr;        // Highest received sequence number
        volatile uint16_t highestSeqNrTx;      // Highest fed back sequence number
        volatile uint32_t receiveTimestamp;    // Wall clock time
        volatile uint64_t ackVector;           // List of received packets
